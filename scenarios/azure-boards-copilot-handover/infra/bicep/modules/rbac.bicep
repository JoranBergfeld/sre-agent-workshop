...
var azureServiceBusDataSenderRoleId = subscriptionResourceId(
  'Microsoft.Authorization/roleDefinitions',
...
resource serviceBusDataSender 'Microsoft.Authorization/roleAssignments@2022-04-01' = {
  name: guid(orderEventsQueue.id, principalId, azureServiceBusDataSenderRoleId)
  scope: orderEventsQueue
  properties: {
    principalId: principalId
    principalType: 'ServicePrincipal'
    roleDefinitionId: azureServiceBusDataSenderRoleId
  }
}
