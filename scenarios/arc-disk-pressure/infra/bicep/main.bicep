// ──────────────────────────────────────────────────────────────
// Azure SRE Agent Scenario — Arc-Enabled Server Disk Pressure (C: Pressure)
// Composes the self-contained VM workload and its disk-pressure alert.
// ──────────────────────────────────────────────────────────────

targetScope = 'resourceGroup'

@description('Azure region for the Arc-Enabled Server Disk Pressure scenario resources')
@allowed([
  'eastus2'
  'swedencentral'
  'australiaeast'
...
param workloadName string = 'srelabarcdisk'
