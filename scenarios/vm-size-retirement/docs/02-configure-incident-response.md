...
Before connecting Azure Monitor, complete
[03 Onboard the SRE Agent](./03-onboard-sre-agent.md).
...
Map `rg-srelabretirement` in the portal's Azure Resources configuration. This
ensures the configured agent can read Azure Monitor and Resource Graph data.
