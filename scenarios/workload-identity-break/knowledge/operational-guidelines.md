...
3. After the PR is merged, an operator manually triggers **Deploy Workload
   Identity Break Infrastructure** to apply the change (deployment is
   intentionally manual via `workflow_dispatch`, not automatic on merge)
